...
export const mission = {
  ...
  /** Destacado tipograficamente: é o princípio fundador da instituição. */
  principle:
    "Apesar da rápida expansão, o pilar principal da instituição permanece intacto: a educação financeira deve sempre vir antes de qualquer decisão de investimento.",
  closing:
    "É esse princípio que coloca o brasileiro no controle do próprio dinheiro e no caminho da liberdade financeira.",
  photo: {
